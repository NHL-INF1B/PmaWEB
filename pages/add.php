...
if (isset($_GET['projectid']) && isset($_GET['token'])) {
    ...
    $_SESSION['projectid'] = filter_var(htmlentities($_GET['projectid']), FILTER_SANITIZE_SPECIAL_CHARS);
    $_SESSION['token'] = filter_var(htmlentities($_GET['token']), FILTER_SANITIZE_SPECIAL_CHARS);
